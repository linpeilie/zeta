...
状态：Phase 0–2 已落地；Phase 3 第 1、2 批生产观察中，第 3 批 3a 默认关闭开工
...
**状态：第 1、2 批已于 2026-08-23 生产翻旗并独立观察；第 3 批 3a 已以默认关闭
flag 开工。**
...
2026-08-30 关批。
同日经显式要求提前启动第 3 批；当前只落地 Project Threads 的字段级契约、纯 Dart
切片与双路径对照，`projectThreadsSliceEnabled` 在生产入口显式为 false，尚未翻旗，
Usage Statistics 也尚未迁移。
开门/关门标准、六批的 owner 映射与删除清单、燃尽清单联动表见
[Phase 3 开工文档](./phase3_slice_expansion.md)。

经 2026-08-23 另行显式确认，第 2 批可在第 1 批观察期间提前进入默认关闭 flag 的
挂旗与对照阶段；同日后续再次确认授权生产翻旗，并明确接受观察窗口重叠。第 2 批
字段级执行契约见
