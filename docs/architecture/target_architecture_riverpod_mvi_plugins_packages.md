...
状态：Phase 0–2 已落地；Phase 3 第 1 批观察中，第 2 批已按默认关闭 flag 开工
...
挂旗与对照阶段，生产翻旗不在此次确认范围。第 2 批字段级执行契约见
