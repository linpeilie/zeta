...
| `features/agent/domain/agent_turn_activity_models.dart` | rewrite | `packages/agent_provider_contracts/lib/src/` | ADR-001 model exception: 21 capability ports plus neutral immutable models; zero vendor fields |
