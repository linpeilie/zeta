...
final class AgentPermissionRequest {
  AgentPermissionRequest({
    ...
    this.sessionId,
    this.turnId,
    Map<String, Object?> fileChanges = const <String, Object?>{},
    List<String> commandActions = const <String>[],
    List<String> proposedExecpolicyAmendment = const <String>[],
    Map<String, Object?> raw = const <String, Object?>{},
  }) : fileChanges = immutableJsonMap(fileChanges),
       commandActions = immutableList(commandActions),
       proposedExecpolicyAmendment = immutableList(
...
/// 用户对审批请求的决定。
final class AgentPermissionDecision {
  ...
  }) : execpolicyAmendment = immutableList(execpolicyAmendment);
