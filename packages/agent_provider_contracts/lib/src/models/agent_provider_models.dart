...
/// 复制到每个项目状态里。
final class AgentProviderConfig {
  AgentProviderConfig({
    required this.id,
  ...
  static final AgentProviderConfig defaultCodex = AgentProviderConfig(
  ...
  static final AgentProviderConfig defaultGrok = AgentProviderConfig(
  ...
  /// 动态拼装；此处只固定命令与 kind。
  static final AgentProviderConfig defaultClaudeCode = AgentProviderConfig(
...
/// 由 IDE 会话状态维护。
final class AgentProviderSettings {
...
final class AgentProviderStatus {
  ...
  /// Typed status code mapped to localized copy by Presentation.
  final AgentProviderStatusCode code;

  /// Optional raw diagnostics for logs; never rendered directly.
