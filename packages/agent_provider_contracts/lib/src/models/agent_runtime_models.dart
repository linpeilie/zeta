...
/// Provider 运行时实例的隔离范围。
///
/// [AgentProviderRuntimeScopeKey.global] 由 `AgentProviderGlobalRuntime` 使用；
/// `session` scope 仅由
...
final class AgentProviderRuntimeGlobalScope
  ...
  @override
  bool operator ==(Object other) => other is AgentProviderRuntimeGlobalScope;
