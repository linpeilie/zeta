...
final class AgentSkillsCatalogEntry {
  ...
  bool operator ==(Object other) =>
      ...
      other.cwd == cwd &&
      const ListEquality<Object?>().equals(other.skills, skills) &&
      const ListEquality<Object?>().equals(other.errors, errors);
...
final class AgentSkillsCatalog {
  ...
  /// 展平后的全部 skill（保持条目顺序）。
  List<AgentSkillMetadata> get allSkills => immutableList(
    <AgentSkillMetadata>[for (final entry in entries) ...entry.skills],
  );
  ...
  @override
  bool operator ==(Object other) =>
      other is AgentSkillsCatalog &&
      const ListEquality<Object?>().equals(other.entries, entries);
