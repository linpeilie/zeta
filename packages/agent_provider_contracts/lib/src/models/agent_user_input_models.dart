...
final class AgentTextUserInput extends AgentUserInput {
  AgentTextUserInput(
    this.text, {
    List<AgentTextElement> textElements = const <AgentTextElement>[],
  }) : textElements = immutableList(textElements);
