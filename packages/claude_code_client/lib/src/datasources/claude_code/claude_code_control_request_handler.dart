...
enum ClaudeCodeToolPermissionOutcome {
  ...
  /// The `allowAlways` value.
  allowAlways,

  /// The `denyOnce` value.
  denyOnce,

  /// The `denyAlways` value.
  denyAlways,
}
...
final class ClaudeCodeControlRequestResult {
  /// Creates a [ClaudeCodeControlRequestResult].
...
/// [ClaudeCodeControlRequestHandler.resolveDecision] 的编码结果。
final class ClaudeCodeControlDecisionResult {
  /// Creates a [ClaudeCodeControlDecisionResult].
...
final class ClaudeCodePendingToolPermission {
  /// Creates a [ClaudeCodePendingToolPermission].
