    ...
    test(
      ...
      () async {
        ...
        final macReader = ClaudeCodeOAuthCredentialsReader(
          ...
          fileSource: const _StaticCredentialsFileSource(null).call,
          isMacOS: true,
          clock: () => now,
        );
        final windowsReader = ClaudeCodeOAuthCredentialsReader(
          credentialsPath: r'C:\fixture\.claude\.credentials.json',
          fileSource: _StaticCredentialsFileSource(credentialsJson).call,
          isMacOS: false,
          clock: () => now,
        );
...
final class _StaticCredentialsFileSource {
  ...
  Future<String?> call(String path) async => contents;
}
