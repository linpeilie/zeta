...
class _CodexAppServerClient {
  ...
  Future<AgentUsageQuotaSnapshot?> readUsageQuota() async {
    ...
    return AgentUsageQuotaSnapshot(
      ...
      reachedReasonCode: _usageLimitReason(
        _string(rateLimits['rateLimitReachedType']),
      ),
    );
  }

  AgentUsageLimitReasonCode? _usageLimitReason(String? value) {
    return switch (value) {
      null => null,
      'quotaExhausted' => AgentUsageLimitReasonCode.quotaExhausted,
      'rateLimited' => AgentUsageLimitReasonCode.rateLimited,
      'accountRestricted' => AgentUsageLimitReasonCode.accountRestricted,
      _ => AgentUsageLimitReasonCode.unknown,
    };
  }
