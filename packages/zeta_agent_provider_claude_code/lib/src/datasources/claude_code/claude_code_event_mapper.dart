...
import 'package:zeta_agent_provider_claude_code/src/datasources/claude_code/claude_code_file_change_tracker.dart';
        ...
        events.add(
          AgentToolCallEvent(
            AgentToolCall(
              ...
              sessionId: resolved.sessionId,
              turnId: resolved.turnId,
              rawInput: wrapAgentProviderPayload(tracked.rawInput),
              raw: wrapAgentProviderPayload(const <String, Object?>{}),
