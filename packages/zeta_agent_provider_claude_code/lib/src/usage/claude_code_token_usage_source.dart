import '../datasources/claude_code/claude_code_session_history_reader.dart';
import 'dart:io';

import 'package:zeta_agent_core/zeta_agent_core.dart';
import 'package:zeta_agent_provider_claude_code/src/usage/claude_code_usage_partition_codec.dart';
...
final class ClaudeCodeTokenUsageSource implements AgentTokenUsageSource {
  factory ClaudeCodeTokenUsageSource({
    ...
    required AgentUsagePartitionPort partitionStore,
    ...
    AgentUsageSourceTextCatalog? textCatalog,
  }) {
    return ClaudeCodeTokenUsageSource._(
      ...
      textCatalog: textCatalog ?? const FallbackAgentUsageSourceTextCatalog(),
    );
  }
