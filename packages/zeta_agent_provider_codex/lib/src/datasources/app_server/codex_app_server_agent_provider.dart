...
import 'package:zeta_agent_provider_codex/src/datasources/app_server/codex_permission_policy_adapter.dart';
import 'package:zeta_agent_provider_codex/src/datasources/app_server/codex_process_starter.dart';
...
import 'package:zeta_agent_provider_codex/src/mappers/codex_permission_policy_codec.dart';
import 'package:zeta_agent_core/zeta_agent_core.dart';
import 'package:zeta_agent_provider_codex/src/mappers/codex_provider_payload.dart';
...
class CodexAppServerAgentProvider
  ...
  AgentProviderCapabilities _capabilities = codexStaticCapabilities;
  ...
  ///
  /// 原文由本 Provider 自己留存（never leaves `zeta_agent_provider_codex`），
  /// 中立事件模型不再携带 raw。
