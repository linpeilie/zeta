import 'package:zeta_agent_provider_codex/src/codex_cli_locator.dart';
...
class CodexAgentManagementRepository
  ...
  final AgentManagementModelCatalogPort? modelCatalogRepository;
  final AgentProviderRuntimeRegistry runtimeRegistry;
  final AgentManagementTextCatalog _textCatalog;

  @override
  String get agentId => codexAgentManagementDefinition.id;
  ...
  AgentProviderConfig _providerConfig(
    ...
    return current.copyWith(
      id: codexAgentManagementDefinition.id,
      displayName: codexAgentManagementDefinition.displayName,
