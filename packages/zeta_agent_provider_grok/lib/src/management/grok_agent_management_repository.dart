import 'package:zeta_agent_provider_grok/src/grok_cli_locator.dart';
...
class GrokAgentManagementRepository
  ...
  @override
  String get agentId => grokAgentManagementDefinition.id;
  ...
  AgentProviderConfig _providerConfig(
    ...
    return current.copyWith(
      id: grokAgentManagementDefinition.id,
      displayName: grokAgentManagementDefinition.displayName,
