...
import 'package:zeta_agent_provider_grok/src/mappers/grok_file_change_tracker.dart';
import 'package:zeta_agent_provider_grok/src/mappers/grok_stream_identity.dart';
    ...
    return GrokAcpMappedUpdate(
      events: <AgentEvent>[
        AgentMessageDeltaEvent(
          ...
          raw: _wrapGrokUpdateEnvelope(update.raw),
        ),
      ],
    );
  }
...
AgentProviderRawPayload _wrapGrokUpdateEnvelope(Map<String, Object?> envelope) {
