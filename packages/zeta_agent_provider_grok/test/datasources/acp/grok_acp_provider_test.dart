    ...
    test(
      ...
      () async {
        ...
        final fineMessages = records
            .where((record) => record.level == 'trace')
  ...
  group('GrokAcpNotificationMapper', () {
    ...
    test('maps turn_completed usage as turn-absolute with apiDurationMs', () {
      ...
      final mapped = mapper.mapXaiSessionUpdate(
        params: providerTestFiles.readFixtureJsonMap(
    ...
    test('keeps redacted x.ai updates page fixture parseable', () {
      final page = providerTestFiles.readFixtureJsonMap(
    ...
    return switch (method) {
      'initialize' => <String, Object?>{
        ...providerTestFiles.readFixtureJsonMap(
          'grok/acp/initialize_0_2_101_redacted.json',
        ),
      ...
      'session/new' => providerTestFiles.readFixtureJsonMap(
      ...
      'session/load' => () {
        ...
        return providerTestFiles.readFixtureJsonMap(
      ...
      '_x.ai/skills/list' => providerTestFiles.readFixtureJsonMap(
        'grok/acp/xai_skills_list_response.json',
      ),
      '_x.ai/billing' => providerTestFiles.readFixtureJsonMap(
