...
void main() {
  ...
  test('the complete shadcn copy surface resolves from ARB', () async {
    final copy = await load('en');
    final values = <String>[
      copy.formNotEmpty,
      copy.invalidValue,
      copy.invalidEmail,
      copy.invalidURL,
      copy.formPhoneNumberInvalid,
      copy.formPhoneNumberEmpty,
      copy.formPasswordDigits,
      copy.formPasswordLowercase,
      copy.formPasswordUppercase,
      copy.formPasswordSpecial,
      copy.commandSearch,
      copy.commandEmpty,
      copy.datePickerSelectYear,
      copy.abbreviatedMonday,
      copy.abbreviatedTuesday,
      copy.abbreviatedWednesday,
      copy.abbreviatedThursday,
      copy.abbreviatedFriday,
      copy.abbreviatedSaturday,
      copy.abbreviatedSunday,
      copy.monthJanuary,
      copy.monthFebruary,
      copy.monthMarch,
      copy.monthApril,
      ...
      copy.monthNovember,
      copy.monthDecember,
      copy.abbreviatedJanuary,
      copy.abbreviatedFebruary,
      copy.abbreviatedMarch,
      copy.abbreviatedApril,
      copy.abbreviatedMay,
      copy.abbreviatedJune,
      copy.abbreviatedJuly,
      copy.abbreviatedAugust,
      copy.abbreviatedSeptember,
      copy.abbreviatedOctober,
      copy.abbreviatedNovember,
      copy.abbreviatedDecember,
      copy.buttonCancel,
      copy.buttonSave,
      copy.timeHour,
      copy.timeMinute,
      ...
      copy.menuShare,
      copy.menuSearchWeb,
      copy.menuLiveTextInput,
      copy.placeholderDatePicker,
      copy.placeholderTimePicker,
      copy.placeholderColorPicker,
      copy.buttonPrevious,
      copy.buttonNext,
      copy.refreshTriggerPull,
      copy.refreshTriggerRelease,
      copy.refreshTriggerRefreshing,
      copy.refreshTriggerComplete,
      copy.colorPickerTabRecent,
      copy.colorPickerTabRGB,
      copy.colorPickerTabHSV,
      copy.colorPickerTabHSL,
      copy.colorPickerTabHEX,
      copy.commandMoveUp,
      copy.commandMoveDown,
      copy.commandActivate,
      copy.dataTableNext,
      copy.dataTablePrevious,
      copy.dataTableColumns,
      copy.timeDaysAbbreviation,
      copy.timeHoursAbbreviation,
      copy.timeMinutesAbbreviation,
      copy.timeSecondsAbbreviation,
      copy.placeholderDurationPicker,
      copy.durationDay,
      copy.durationHour,
      copy.durationMinute,
      copy.durationSecond,
      copy.formGreaterThan(1),
      copy.formLessThanOrEqualTo(1),
      copy.formGreaterThanOrEqualTo(1),
      copy.formBetweenExclusively(1, 2.5),
      copy.formLengthLessThan(3),
      copy.formLengthGreaterThan(3),
      copy.dataTableSelectedRows(1, 2),
    ];

    expect(values, everyElement(isNotEmpty));
    expect(
      ZetaShadcnLocalizations.delegate.shouldReload(
  ...
  test('D6 date, number and duration snapshots stay language-stable', () async {
    ...
    expect(
      en.formatTimeOfDay(const sf.TimeOfDay(hour: 9, minute: 7)),
      zh.formatTimeOfDay(const sf.TimeOfDay(hour: 9, minute: 7)),
    );
